...
open class Palette: UIView
{
    ...
    open func setNewColorPick(newColor: UIColor) {
        brush.color = newColor
        updateColorOfButtons([self.colorButtonList[3]], color: newColor)
        updateColorOfButtons(self.alphaButtonList, color: newColor, enable: true)
        updateColorOfButtons(self.widthButtonList, color: newColor)
    }
}
