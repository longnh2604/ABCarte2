...
@objc public protocol CanvasDelegate {
    ...
    func brush() -> Brush?
    @objc optional func updatingNewColor(color:UIColor)
    @objc optional func updateTouch(penTouch: Bool)
}
            ...
            if (touch.type == .pencil) {
                ...
                if penMode == 1 {
                    ...
                    if drawMode == DrawMode.kEraser.rawValue {
                        ...
                        delegate?.updatingNewColor?(color: pixelColor)
                    } else {
                        self.brush.isEraser = false
...
//        }
    ...
    open func setDrawingMode(mode: Int) {
        ...
        case 5:
            drawMode = DrawMode.kNothing.rawValue
        case 6:
